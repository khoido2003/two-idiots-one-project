...
<main class="container mx-auto px-4 py-6 sm:py-8">
	...
	>
		...
		<div class="relative max-w-4xl mx-auto z-10">
			...
			<p class="text-base sm:text-lg md:text-xl max-w-2xl mx-auto mb-6 font-pixel text-retroCoral">
	...
	<section class="mb-12 sm:mb-16 relative">
		<h2 class="font-pixel text-2xl sm:text-3xl text-retroGray mb-6 text-center">Hot Retro Finds</h2>
		<div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6 sm:gap-8 justify-items-center">
	...
	<section class="mb-12 sm:mb-16 py-12 bg-retroCream rounded-2xl">
		<h2 class="font-pixel text-2xl sm:text-3xl text-retroGray mb-6 text-center">New Arrivals</h2>
	...
	<section class="mt-10 mb-12 sm:mb-16 py-12 bg-stone-600 rounded-2xl text-retroCream">
		<h2 class="font-pixel text-2xl sm:text-3xl text-center mb-4 text-retroPeach">Limited Deals</h2>
		...
		<div class="max-w-2xl mx-auto p-6">
			{#each limitedDeals as deal}
				<div class="bg-white p-6 rounded-lg border-4 border-retroPlum shadow-[4px_4px_0_#ff6f61]">
					<img
						src={deal.image}
						alt={deal.name}
					...
					<div class="flex justify-between items-center mt-4">
						<div>
							...
							<span class="text-retroGray line-through ml-2 opacity-70">${deal.originalPrice}</span>
						</div>
						<Button
							variant="primary"
	...
	<section class="bg-retroBlack py-16 px-3 sm:py-16 mb-12 sm:mb-16 rounded-2xl">
		...
		<div class="container mx-auto px-4 grid grid-cols-1 sm:grid-cols-3 gap-6 sm:gap-8">
			...
			>
				<iconify-icon class="h-7 w-7" icon="mdi:shield-crown" with="28" height="28"></iconify-icon>
		...
		<div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
			{#each testimonials as testimonial}
				...
				>
					...
					<p class="text-sm sm:text-base text-retroGray font-pixel mb-4">"{testimonial.quote}"</p>
					<p class="font-pixel text-retroCoral text-sm sm:text-base">- {testimonial.name}</p>
				</div>
			{/each}
		</div>
	</section>
...
<footer class="bg-retroGray text-retroCream py-6 sm:py-8 relative">
	...
	<div class="container mx-auto px-4 text-center relative z-10">
		...
		<div class="flex justify-center space-x-4 sm:space-x-6">
			<a href="/about" class="hover:text-retroCoral transition-colors text-sm sm:text-base">About</a
			>
			<a href="/contact" class="hover:text-retroCoral transition-colors text-sm sm:text-base"
				>Contact</a
			>
			<a href="/terms" class="hover:text-retroCoral transition-colors text-sm sm:text-base">Terms</a
			>
		</div>
	</div>
</footer>
